...
namespace AtCoderDotNetCore
{
	...
	public static class Question
	{
		...
		public static void Exec()
		{
			...
			{
				builder.Append(hlist[i] + " ");
			}
			Console.WriteLine(builder.ToString());
			builder.Clear();

			for (var i = 0; i < rui1.Length; ++i)
			{
				builder.Append(rui1[i] + " ");
			}
			Console.WriteLine(builder.ToString());
			builder.Clear();

			for (var i = 0; i < rui2.Length; ++i)
			{
				builder.Append(rui2[i] + " ");
			}
			Console.WriteLine(builder.ToString());
			builder.Clear();
			*/
			...
			for (var i = 0; i < w.Length; ++i)
			{
				...
				} else
                {
					...
					count += value + value2;
					//Console.WriteLine($"{w[i]}, {left}, {right}, {index}, {value}, {value2}, {count}");
				}
